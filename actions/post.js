...
//   console.log("postText", postText);
  try {
    ...
    // console.log("andar aaya try ke andarm create post ke andar");
    //  console.log("user_idttincreatepost", user);
...
export const getPosts = async (lastCursor, id) => {
  try {
    ...
    const take = 5;
    // console.log("getpost ke andar", id);
...
export const getMyPostsFeed = async (lastCursor) => {
  try {
    ...
    // console.log("current user id getmypostfeed ke andar", id);
